...
import jary.bot.message.adapters.ReviveChatMessageAdapter
...
@Component
@Slf4j
class ReviveListener implements Runnable {

    @Autowired
    ReviveChatMessageAdapter chatAdapter
    ...
    void run() {
        ...
        Skype.profile.setStatus(Profile.Status.DND)
    ...
    void interrupt() {
        try {
            ...
            log.debug("interrupting revive listener")
        }
    }
}